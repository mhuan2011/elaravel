...
<div class="container-fluid">
                    ...
                    <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
                        For more information about DataTables, please visit the <a target="_blank"
                            ...
                            <strong>Cập nhật danh mục thành công!</strong> 
                                            ...
                                            <div class="col-sm-12">
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd">
                                                            <td class="sorting_1">{{$cate_pro->category_name}}</td>
                                                            <td>
                                                            <?php
                                                                if($cate_pro->category_status == 0){
                                                            ?>
                                                                <a href="{{URL::to('/unactive-category-product/'.$cate_pro->category_id)}}"><i class="fas fa-eye-slash"></i> Hidden</a>
                                                            <?php
                                                                }else {
                                                            ?>
                                                                <a href="{{URL::to('/active-category-product/'.$cate_pro->category_id)}}"><i class="fas fa-eye"></i> Show</a>
                                                            ...
                                                            <td><a href="{{URL::to('/edit-category-product/'.$cate_pro->category_id)}}" class="btn btn-primary">Sửa</a></td>
                                                            <td><a href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}"  class="btn btn-danger" onclick="return confirm('Danh mục xẽ được xóa?')">Xóa</a></td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
