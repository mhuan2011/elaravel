    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('backend/images/undraw_profile.svg')}}">
                            </a>
            ...
            <footer class=" bg-white">
                <div class="container my-auto" style="height: auto;">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; mhuan_2011</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Chọn "Đăng xuất" bên dưới nếu bạn đã kết thúc phiên làm việc hiện tại</div>
